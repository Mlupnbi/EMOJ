...
namespace EvenMoreOverpoweredJourney.Research
{
    public static class RecipeAnalyzer
    {
        ...
        /// <summary>预热/构建配方索引并返回耗时（毫秒）。</summary>
        ...
        /// <summary>所有「以 seed 为材料之一」的配方产物的 type 去重集合（全局查询基准）。</summary>
        ...
        /// <summary>种子材料可深度合成且材料均已研究的产物列表（不含 RecipeGroup 0.1 近似路径）。</summary>
        ...
        /// <summary>配方是否以精确 type 作为材料（不含 RecipeGroup 替代项）。</summary>
        ...
        /// <summary>消耗材料（精确材料）的配方产物 type 列表；走索引且带上限，避免高扇出材料扫全表。</summary>
        ...
        /// <summary>消耗指定材料（含 RecipeGroup）的配方产物 type 去重列表。</summary>
        ...
        /// <summary>配方所需全部材料（含 RecipeGroup 替代）是否均已研究完成。</summary>
